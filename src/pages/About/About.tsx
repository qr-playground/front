  ...
  const faqItems: FaqItem[] = [
    {
      ...
      answer:
        "대부분의 스마트폰 기본 카메라 앱으로 QR 코드를 스캔할 수 있습니다. 또한 링크로 접근하실 수 있습니다.",
    },
    {
      question: "생성한 QR 코드는 얼마나 오래 사용할 수 있나요?",
      answer:
        "QR코드는 생성 시 설정한 기간동안 사용할 수 있습니다. 단, 오랜 시간 유지하고 싶다면 이메일 문의 부탁드립니다.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "무료로 제공하는 베타 버전입니다. 단, 100명이 넘는 대규모 인원은 이메일 문의 부탁드립니다.",
    },
  ];
